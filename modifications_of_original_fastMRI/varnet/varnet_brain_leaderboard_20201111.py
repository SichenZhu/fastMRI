...
def cli_main(args):
    ...
    # trainer
    # ------------ modification start ---------------
    trainer = pl.Trainer.from_argparse_args(args, callbacks=[args.checkpoint_callback])
    # ------------ modification end ---------------
...
def build_args():
    ...
    # basic args
    path_config = pathlib.Path("fastMRI/yaml/path_dirs.yaml")  # need to create
    backend = "ddp"
    num_gpus = 4
    batch_size = 1
    ...
    # ------------ modification start ---------------
    args.checkpoint_callback = pl.callbacks.model_checkpoint.ModelCheckpoint(
